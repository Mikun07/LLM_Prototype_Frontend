...
`v2.1.0`, `v2.2.0`, `v2.3.0`, and so on. The first post-baseline adjustment is
`v2.1.0`. Do not move `v2.0.0`. Create `v3.0.0` or `v4.0.0` only when a new major
baseline is intentionally created.

## Current Documentation State

The current project version is `2.1.0`. Version `v2.0.0` remains available as the
